                            ...
                            <div className="other-wrapper">
                                ...
                                <div className="pib-courses-wrapper">
                                    ...
                                    <ul className="pib-courses">
                                        <li className="item1">
                                            <a href="/pib/courses/course-law" className="block unline"><span
                                                className="course float-left block"><span
                                                className="orange">081 Право</span></span><span
                                                className="course-desc float-left block">
...
<span href="#" className="gold underline arrow-gold">Дізнатися більше</span></span></a>
                                        </li>

                                        <li className="item3">
                                            <a href="/pib/courses/course-it" className="block unline"><span
                                                className="course float-left block"><span
                                                className="orange">121 Інженерія програмного забезпечення</span></span><span
                                                className="course-desc float-left block">
...
<span className="gold underline arrow-gold">Дізнатися більше</span></span></a>
                                        ...
                                        <li className="item10">
                                            <a href="/pib/courses/course-radio-electronic"
                                               className="block unline"><span
                                                className="course float-left block"><span
                                                className="orange">172 Телекомунікації та радіотехніка</span></span><span
                                                className="course-desc float-left block">
...
<span className="gold underline arrow-gold">Дізнатися більше</span></span></a>
                                        ...
                                        <li className="item4">
                                            <a href="/pib/courses/course-health"
                                               className="block unline"><span
                                                className="course float-left block"><span
                                                className="orange">227 Фізична терапія, ерготерапія</span></span><span
                                                className="course-desc float-left block">
...
<span className="gold underline arrow-gold">Дізнатися більше</span></span></a>
                                        ...
                                        <li className="item5">
                                            <a href="/pib/courses/course-finance"
                                               className="block unline"><span
                                                className="course float-left block"><span
                                                className="orange">072 Фінанси, банківська справа та страхування</span></span><span
                                                className="course-desc float-left block">
...
<span className="gold underline arrow-gold">Дізнатися більше</span></span></a>
                                        ...
                                        <li className="item6">
                                            <a href="/pib/courses/course-accountancy"
                                               className="block unline"><span
                                                className="course float-left block"><span
                                                className="orange">071 Облік і оподаткування</span></span><span
                                                className="course-desc float-left block"><p>В сучасних умовах облік і аудит - інструменти управління, підвищення ефективності господарювання, оскільки забезпечують власників і управлінців, фахівців інформацією про економічні процеси і явища, ресурси та ефективність їх використання у всіх секторах економіки.</p>
<span className="gold underline arrow-gold">Дізнатися більше</span></span></a>
                                        </li>
                                        <li className="item7">
                                            <a href="/pib/courses/course-management"
                                               className="block unline"><span
                                                className="course float-left block"><span
                                                className="orange">073 Менеджмент</span></span><span
                                                className="course-desc float-left block">
...
<span className="gold underline arrow-gold">Дізнатися більше</span></span></a>
                                        ...
                                        <li className="item10">
                                            <a href="/pib/courses/course-ecology"
                                               className="block unline"><span
                                                className="course float-left block"><span
                                                className="orange">101 Екологія</span></span><span
                                                className="course-desc float-left block"><p>Екологічні проблеми, серед яких охорона природи і здоров'я людей, постають одними з найсуттєвіших на сучасному етапі розвитку людського суспільства. Беручи до уваги стан екології та тенденції розвитку економіки України, можна констатувати зростаючу актуальність розв'язання цих проблем.</p>
<span className="gold underline arrow-gold">Дізнатися більше</span></span></a>
                                        </li>
                                        <li className="item10">
                                            <a href="/pib/courses/course-psychology"
                                               className="block unline"><span
                                                className="course float-left block"><span
                                                className="orange">053 Психологія</span></span><span
                                                className="course-desc float-left block"><p>Психологія - одна з тих наук, які з повним правом можна назвати універсальними та вічними. Людська цивілізація стрімко рухається шляхом прогресу, винаходить нові механізми, робить глобальні відкриття, що змушують поглянути на світ та його структуру під абсолютно несподіваним кутом. Але навіть у сучасному світі найбільшою загадкою, альфою та омегою, початком та кінцем всього лишається людина.</p>
<span className="gold underline arrow-gold">Дізнатися більше</span></span></a>
                                        </li>
                                        <li className="item10">
                                            <a href="/pib/courses/course-public-management-and-administration"
                                               className="block unline"><span
                                                className="course float-left block"><span
                                                className="orange">281 Публічне управління та адміністрування</span></span><span
                                                className="course-desc float-left block"><p>Це якісна управлінська освіта, яка є гарантом вашої особистої конкурентоспроможності як менеджера. Мистецтво управління, якого навчають на програмі ПУБЛІЧНЕ УПРАВЛІННЯ ТА АДМІНІСТРУВАННЯ, спирається на глибоке розуміння законів і практики сучасного бізнесу, маркетингу, тенденцій розвитку бізнес-адміністрування. Практично орієнтовані методики навчання, навички реального бізнес-консалтингу, інтенсивний тренінг у прийнятті рішень за допомогою комп’ютерних ділових ігор виробляють у студентів комплексне бачення бізнес-проблем та навички швидкого реагування на виклики нової реальності ведення бізнесу в Україні та за її межами.</p>
<span className="gold underline arrow-gold">Дізнатися більше</span></span></a>
                                        </li>
                                        <li className="item10">
                                            <a href="/pib/courses/course-petroleum-engineering-and-technology"
                                               className="block unline"><span
                                                className="course float-left block"><span
                                                className="orange">185 Нафтогазова інженерія та технології</span></span><span
                                                className="course-desc float-left block"><p>Жодна сировина не викликає стільки хвилювань та не приносить стільки прибутків, як нафта та газ, які є головними енергоносіями. Уміння використовувати ці ключові продукти та їх запаси, тримати в руках ниточки бізнесу у цих напрямках, визначає шлях до економічного процвітання та вибору політичної і економічної стратегії держави.</p>
<span className="gold underline arrow-gold">Дізнатися більше</span></span></a>
                                        </li>
                                    </ul>
                                </div>
