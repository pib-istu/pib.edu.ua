                      ...
                      <li>
                        <div style={COL_STYLE} className="iceCols">
                          <ul>
                            ...
                            <NavItemLink id="iceMenu_183" className="iceMenuLiLevel_3" to="/media/docs/Правила прийому ПІБ МНТУ 2021.pdf" target="_blank" linkClassName=" iceMenuTitle" spanClassName="icemega_title icemega_nosubtitle">Правила прийому ПІБ МНТУ</NavItemLink>
