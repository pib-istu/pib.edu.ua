              ...
              <NavSection match='/business-college/entrance' id="item-219" className="deeper parent">
                ...
                <Loc match='/business-college/entrance'>
                  <ul>
                    ...
                    <NavItemLink id="item-235" to="/media/docs/business-college/Список рекомендованих до зарахування 2022.pdf" target="_blank">Список рекомендованих до зарахування</NavItemLink>
                  </ul>
                </Loc>
              </NavSection>
          </ul>
