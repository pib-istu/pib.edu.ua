// $prev_title: "ПІБ МНТУ - Полтавський інститут Бізнесу - Відгуки"
...
export default () => {
  return (
    <WithSidebar shouldShowSidebar={true}>
      <link rel="stylesheet" href="/modules/mod_icetabs/themes/candy/assets/style.css" />

      <div id="page-header">
        <h1 className="text">
          Відгуки </h1>
      </div>
      <p>Дізнайтеся, що говорять про ПІБ МНТУ наші студенти:</p>

      <div id="icetabs106" className="ice-tabs-white -sl-white" style={{height: 'auto', width: 'auto', paddingTop: '25px', overflow: 'auto'}}>
        <div className="ice-main-wapper" style={{width: '650px', overflow: 'auto'}}>
          <div className="ice-main-item1">
            <div className="opinions_photo">
              <img src="/images/opinions/V-Struk.jpg" title="Вячеслав Стрюк, начальник відділення ПАТ «КБ «ГЛОБУС»" alt="Вячеслав Стрюк, начальник відділення ПАТ «КБ «ГЛОБУС»" /> </div>
            ...
            <div className="opinions_author">
              -&nbsp;Вячеслав Стрюк,<br />&nbsp; начальник відділення ПАТ «КБ «ГЛОБУС» </div>
            <div className="clear-both" /> </div>
          <div className="ice-main-item1">
            <div className="opinions_photo">
              <img src="/images/opinions/R-S-Shenko.jpg" title="Іщенко Роман Сергійович, керівник департаменту непрямих продажів Корпорації «SI GROUP»" alt="Іщенко Роман Сергійович, керівник департаменту непрямих продажів Корпорації «SI GROUP»" /> </div>
            <div className="opinions">
              <div className="opinions_wrapper">
                <div className="opinions_tl">
                </div>
                ...
                <div className="opinions_content">
                  <div className="opinions_quote">“</div>
                  <p style={{padding: '0px'}}>Усім, хто є випускником ПІБ МНТУ, хто пов'язаний з ним, бажаю успіху в досягненні поставленої мети в житті, яка, безумовно, завжди є позитивною!</p> </div>
                <div className="opinions_bl">
                </div>
                <div className="opinions_bbg">
                </div>
            ...
            <div className="opinions_author">
              -&nbsp;Іщенко Роман Сергійович,<br />&nbsp; керівник департаменту непрямих продажів Корпорації «SI GROUP» </div>
            <div className="clear-both" /> </div>
          <div className="ice-main-item1">
            <div className="opinions_photo">
              <img src="/images/opinions/I-Lavka.jpg" alt='Лавка Ірина, ПАТ " Альфа-банк", спеціаліст відділу забезпечення продаж' /> </div>
            <div className="opinions">
              <div className="opinions_wrapper">
                <div className="opinions_tl">
                </div>
            ...
            <div className="opinions_author">
              -&nbsp;Лавка Ірина,<br />&nbsp; ПАТ "Альфа-банк",<br />&nbsp; спеціаліст відділу забезпечення продаж </div>
            <div className="clear-both" /> </div>
          <div className="ice-main-item1">
            <div className="opinions_photo">
              <img src="/images/opinions/Y-Gromik.jpg" title="Громик Юрій Юрійович, головний спеціаліст та інспектор якості, економіст УАР Криничанської райдержадміністрації" alt="Громик Юрій Юрійович, головний спеціаліст та інспектор якості, економіст УАР Криничанської райдержадміністрації" /> </div>
            <div className="opinions">
              <div className="opinions_wrapper">
                <div className="opinions_tl">
                </div>
            ...
            <div className="opinions_author">
              -&nbsp;Громик Юрій Юрійович,<br />&nbsp; головний спеціаліст та інспектор якості,<br />&nbsp; економіст УАР Криничанської райдержадміністрації </div>
            <div className="clear-both" /> </div>
          <div className="ice-main-item1">
            <div className="opinions_photo">
              <img src="/images/opinions/E-Nechupienko.jpg" title="Нечупієнко Єлізавета Володимирівна, інспектор Управління Державної казначейської служби України" alt="Нечупієнко Єлізавета Володимирівна, інспектор Управління Державної казначейської служби України" /> </div>
            <div className="opinions">
              <div className="opinions_wrapper">
                <div className="opinions_tl">
                </div>
            ...
            <div className="opinions_author">
              -&nbsp;Нечупієнко Єлізавета Володимирівна,<br />&nbsp; інспектор Управління Державної казначейської служби України </div>
            <div className="clear-both" /> </div>
        </div>
      </div>

      <div className="custom">
        <a id="comment" /><h2>Відправити відгук:</h2>
        <p style={{paddingLeft: '15px', paddingBottom: '12px'}}>Будь ласка, надсилайте ваші відгуки разом з фото на{' '}
          <a href="mailto:admin@pib.edu.ua" className="gold">admin@pib.edu.ua</a> з приміткою "Відгук для сайта".
        </p>
      </div>
    </WithSidebar>
  )
