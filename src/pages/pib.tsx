  ...
  return (
    <WithSidebar shouldShowSidebar={false}>
      ...
      <div className="other-wrapper">
        <a id="courses" /><h1 className="pib highlight center orange uppercase">Напрями та спеціалізації:</h1>
        <div className="pib-courses-wrapper">
          ...
          <ul className="pib-courses">
            <li className="item1">
              <a href="/pib/courses/course-law" className="block unline"><span className="course float-left block"><span className="orange">081 Право</span></span><span className="course-desc float-left block">
            ...
            <li className="item3">
              <a href="/pib/courses/course-it" className="block unline"><span className="course float-left block"><span className="orange">121 Інженерія програмного забезпечення</span></span><span className="course-desc float-left block">
            ...
            <li className="item10">
              <a href="/pib/courses/course-radio-electronic" className="block unline"><span className="course float-left block"><span className="orange">172 Телекомунікації та радіотехніка</span></span><span className="course-desc float-left block">
            ...
            <li className="item4">
              <a href="/pib/courses/course-health" className="block unline"><span className="course float-left block"><span className="orange">227 Фізична терапія, ерготерапія</span></span><span className="course-desc float-left block">
            ...
            <li className="item5">
              <a href="/pib/courses/course-finance" className="block unline"><span className="course float-left block"><span className="orange">072 Фінанси, банківська справа та страхування</span></span><span className="course-desc float-left block">
            ...
            <li className="item6">
              <a href="/pib/courses/course-accountancy" className="block unline"><span className="course float-left block"><span className="orange">071 Облік і оподаткування</span></span><span className="course-desc float-left block"><p>В сучасних умовах облік і аудит - інструменти управління, підвищення ефективності господарювання, оскільки забезпечують власників і управлінців, фахівців інформацією про економічні процеси і явища, ресурси та ефективність їх використання у всіх секторах економіки.</p>
                  <span className="gold underline arrow-gold">Дізнатися більше</span></span></a>
            </li>
            <li className="item7">
              <a href="/pib/courses/course-management" className="block unline"><span className="course float-left block"><span className="orange">073 Менеджмент</span></span><span className="course-desc float-left block">
      ...
      <ul id="pib-buttons-bottom">
        ...
        <li className="item2 float-left">
          <a href="/pib/military" className="unline block">
